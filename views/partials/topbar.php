...
<header class="cy-topbar">
    ...
    <div class="cy-topbar__actions">
        ...
        <?php /* DİL SEÇİCİ
                 Her zaman görünür olmalıdır: dili yanlış açılan bir
                 kullanıcı, ayarlar sayfasını bulacak kadar bile
                 okuyamayabilir. Bu yüzden ayarların içine değil,
                 üst çubuğa koyuyoruz. */ ?>
