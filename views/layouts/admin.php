...
<head>
    ...
    <title><?= e($pageTitle) ?> · <?= e($appName ?? 'CY i18n') ?></title>
...
<body class="cy-app<?= $collapsed ? ' is-collapsed' : '' ?>">
    ...
    <div class="cy-shell">
        ...
        <div class="cy-main">
            ...
            <footer class="cy-footer">
                ...
                ·
                <a href="https://github.com/CilginYazilim/multi-language-system"
    ...
    <?php // Dil tercihini hesaba kaydeder (dil değişimi bağlantının kendi işidir) ?>
    <script src="<?= e(asset('js/lang.js')) ?>"></script>
