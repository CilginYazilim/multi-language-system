...
final class User
{
    ...
    /**
     * Dil kodunu beyaz listeden geçirir.
     *
     * Desteklenmeyen bir kod veritabanına yazılırsa, o kullanıcı
     * her girişinde bulunamayan bir sözlük dosyası aranır ve arayüz
     * ham anahtarlarla dolar. Kapıda elemek en ucuzudur.
     */
    public static function normalizeLocale(mixed $value): string
    {
        return is_string($value) && \App\Core\Translator::supports($value) ? $value : 'tr';
    }
    ...
    public function __construct(
        ...
        /**
         * Arayüz dili ("tr", "en", "ar"). Tema gibi HESABA bağlıdır:
         * kullanıcı hangi cihazdan girerse girsin kendi dilini bulur.
         * Yalnızca çerezde tutulsaydı, tarayıcı değiştirdiğinde veya
         * çerezleri temizlediğinde tercihi kaybolurdu.
         */
    ...
    public static function fromRow(array $row): self
    {
        return new self(
            ...
            locale:       self::normalizeLocale($row['locale'] ?? 'tr'),
